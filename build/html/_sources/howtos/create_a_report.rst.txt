...
of
`DESeq2 <https://github.com/kbaseapps/kb_deseq/blob/add70f879a93f060c2b37de914dab7d0c02731c1/lib/kb_deseq/Utils/DESeqUtil.py#L241-L285>`__.

.. figure:: http://kbase.us/wp-content/uploads/2017/11/DeSEQ-Capture.png
   :alt: DESeq2 Report

   DESeq2 Report

The first step in setting up KBase reports for an App is determining
...
can be set to configure the output:

Here's the same example image from above annotated with the parameters
used in the creation of the DESeq2 report.

.. figure:: http://kbase.us/wp-content/uploads/2017/11/DESeq2-Annotate.png
   :alt: DESeq2 Report

   DESeq2 Report

\`\`\`python def \_generate\_report (self, params, other\_stuff):
